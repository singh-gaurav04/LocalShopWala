...
const Category = () => {
  ...
  return (
    <div
      className="grid grid-cols-2 md:grid-cols-10 gap-2 mt-4 "
      // style={{
      //   backgroundImage:
      //     "url('https://media.istockphoto.com/id/682171198/photo/green-spotlight-smoke-background.jpg?s=612x612&w=0&k=20&c=MPtz6zeJdxzBuZweKY0iywnmBseGaGjUrXZo7R4n-NE=')",
      // }}
    >
