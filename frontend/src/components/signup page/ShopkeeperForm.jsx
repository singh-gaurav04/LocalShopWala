...
<div className='signup-container w-[600px]  rounded-[40px] px-[25px] py-8  border-[5px] border-solid shadow-[#85BDD7E0]'>

{/* This is the heading of the signup form/comtainer */}
<div className='heading text-center font-[900] text-[30px] text-[#1089D3] '> REGISTER SHOP </div>
